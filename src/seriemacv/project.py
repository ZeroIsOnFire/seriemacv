...
class OperationMetricsConfiguration(BaseModel):
    """Bounded local operation-metrics configuration."""

    model_config = ConfigDict(extra="forbid", strict=True)

    output_warning_bytes: int = Field(default=65_536, ge=1)
...
class ProjectConfiguration(BaseModel):
    ...
    operation_metrics: OperationMetricsConfiguration = Field(
        default_factory=OperationMetricsConfiguration
    )
