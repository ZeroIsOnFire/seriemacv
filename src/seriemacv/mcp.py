...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Return a reviewable answer-proposal envelope; it never writes career.yml or an application.",
        "inputSchema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "Return minimal verified context and detected form questions for an external AI agent; never writes.",
        "inputSchema": {
            "type": "object",
    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "seriemacv", "version": "0.1.0"},
            },
        }
...
def _call(name: str, arguments: dict[str, Any]) -> str:
    ...
    if name == "get_application_questions":
        return dump_application(
            pending_questions(project_path, arguments["application_id"])
        )
        ...
        return _yaml(
            {
                ...
                "persistence": "Use 'seriemacv applications apply-answer' only after explicit user confirmation.",
            }
        )
